...
GRANT SELECT ON public.categories,public.profiles,public.items,public.item_images,public.item_videos,
  ...
  public.deal_message_reads,public.deal_confirmations,public.reviews,public.user_blocks TO teswa_app_authenticated;
...
GRANT EXECUTE ON FUNCTION public.follow_user(uuid),public.unfollow_user(uuid),
  ...
  public.get_user_trust_metrics(uuid),public.get_user_badges(uuid),public.refresh_my_badges()
