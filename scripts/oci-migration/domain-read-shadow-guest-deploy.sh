...
for file in oracle_domain_read.py oracle_marketplace_write.py oracle_exchange.py oracle_exchange_read.py oracle_exchange_read_extra.py oracle_media.py oracle_profiles.py oracle_domain_service.py auth-api-shadow-gateway.py runtime-domain-api-grants.sql domain_exchange_e2e.py; do
