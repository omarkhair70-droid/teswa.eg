...
def main():
    ...
    names=('oracle_domain_read.py','oracle_marketplace_write.py','oracle_exchange.py','oracle_media.py','oracle_domain_service.py','auth-api-shadow-gateway.py','runtime-domain-api-grants.sql','domain-read-shadow-guest-deploy.sh')
