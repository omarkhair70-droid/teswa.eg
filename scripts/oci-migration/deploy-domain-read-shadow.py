...
def main():
    ...
    names=('oracle_domain_read.py','oracle_marketplace_write.py','oracle_marketplace_lifecycle.py','oracle_marketplace_edit.py',
           ...
           'oracle_reviews.py','oracle_direct_messaging.py','oracle_contextual_messaging.py','oracle_stories.py','oracle_discovery.py','oracle_dolab.py','diagnose_oracle_profile.py','runtime-domain-api-grants.sql','runtime-marketplace-edit.sql','runtime-marketplace-image-plan.sql',
