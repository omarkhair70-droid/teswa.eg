...
const styles = StyleSheet.create({ card: { borderWidth: 1, borderColor: colors.border, borderRadius: radii.xl, backgroundColor: colors.surface, padding: spacing.md, gap: spacing.sm }, row: { flexDirection: 'row', justifyContent: 'space-between', gap: spacing.sm }, actions: { alignItems: 'flex-end', gap: spacing.xs }, link: { color: colors.primary }, linkMuted: { color: colors.textMuted }, cacheNotice: { borderWidth: 1, borderColor: colors.border, borderRadius: radii.md, backgroundColor: colors.background, padding: spacing.sm }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.xs }, chip: { backgroundColor: colors.primarySoft, borderRadius: radii.md, paddingHorizontal: spacing.sm, paddingVertical: spacing.xs }, chipText: { color: colors.primary, fontSize: 12 }, section: { gap: spacing.xs }, rail: { gap: spacing.sm, paddingRight: spacing.md }, itemCard: { width: 180, borderWidth: 1, borderColor: colors.border, borderRadius: radii.lg, padding: spacing.sm, gap: spacing.xs, backgroundColor: colors.white }, personCard: { width: 120, gap: spacing.xs, alignItems: 'center' }, avatar: { width: 56, height: 56, borderRadius: radii.round }, avatarFallback: { width: 56, height: 56, borderRadius: radii.round, backgroundColor: colors.primarySoft, alignItems: 'center', justifyContent: 'center' }, thumb: { width: '100%', height: 100, borderRadius: radii.md, backgroundColor: colors.background }, thumbFallback: { alignItems: 'center', justifyContent: 'center' }, micro: { color: colors.primary, fontSize: 12 }, badge: { color: colors.accent, fontSize: 12 }, error: { color: '#B42318' }, errorInline: { borderWidth: 1, borderColor: '#B42318', borderRadius: radii.md, padding: spacing.sm, gap: spacing.xs } });
