...
const styles = StyleSheet.create({
  ...
  filterScroller: { flexGrow: 0, marginTop: 9 },
  filters: { paddingHorizontal: 14, gap: 7, flexDirection: 'row-reverse' },
  ...
  listContent: { paddingHorizontal: 14, paddingTop: 9, paddingBottom: 24 },
