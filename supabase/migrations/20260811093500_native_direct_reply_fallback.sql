-- A reply target can disappear between composing and sending. Treat a stale or
-- deleted reply target as a normal send instead of rejecting the whole message,
-- which is especially important after media has already been uploaded.
