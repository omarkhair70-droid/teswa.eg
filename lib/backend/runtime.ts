...
import type { MessagingRealtimeContract } from '@/lib/backend/contracts/messaging';

export type TeswaBackendRuntime = Pick<TeswaBackend, 'auth' | 'media'> & { profiles: ProfileCoreContract; marketplace: MarketplaceReadContract; offers: OfferLifecycleContract; deals: DealLifecycleContract; realtime: MessagingRealtimeContract };
